...
#     url(r'^admin/', include(admin.site.urls)),
    ...
    url(r'^viewInstance/(?P<id>[0-9]+)/(?P<vm>\w+-?\w+)/$',vInstance.viewInstance),
    url(r'^status/cpu/(?P<id>[0-9]+)/(?P<vm>\w+-?\w+)/$',vInstance.instanceCpuStatus),
    url(r'^status/net/(?P<id>[0-9]+)/(?P<vm>\w+-?\w+)/$',vInstance.instanceNetStatus),
    url(r'^status/disk/(?P<id>[0-9]+)/(?P<vm>\w+-?\w+)/$',vInstance.instanceDiskStatus),
    ...
    url(r'^viewStorage/(?P<id>[0-9]+)/(?P<name>\w+-?\w+)/$',vStorage.viewStorage),  
